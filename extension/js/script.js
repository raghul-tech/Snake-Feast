...
function food_cell(x, y) {
	...
	//Keyboard controller
	var Direction = false;
/*	var isMouseOverCanvas = false; // Track mouse position relative to the canvas
...
$(canvas).on("mouseenter", function() {
    isMouseOverCanvas = true; // Mouse is over the canvas
});

$(canvas).on("mouseleave", function() {
    isMouseOverCanvas = false; // Mouse is not over the canvas
});
// Optional: track mouse movements if needed
$(canvas).on("mousemove", function() {
    // Update mouse position (if needed for other functionalities)
    isMouseOverCanvas = true
});*/
	$(document).keydown(function(e){
		var key = e.which;
		  // Prevent default scrolling actions only if mouse is over the canvas
