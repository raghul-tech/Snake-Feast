...
class ScoreBridge(QObject):
    ...
    JS calls:
        ...
        window.pyBridge.saveScore(mode, value)  → saves one score
    """
...
class MainWindow(QMainWindow):
    ...
    def keyPressEvent(self, e):
        ...
        Toggles fullscreen mode with F11 and exits fullscreen with Escape.
        """
...
if __name__ == "__main__":
    """
    Main entry point for the Snake Feast game.
